...
const IconStrategicPartnership = () => (
  <svg width="38" height="38" viewBox="0 0 40 40" fill="none">
    ...
    <path
      d="M20 12.5 C22.8 15 22.8 25 20 27.5"
      stroke={G1}
      strokeWidth="1.2"
      fill="none"
    />
    <path
      d="M20 12.5 C17.2 15 17.2 25 20 27.5"
      stroke={G2}
      strokeWidth="1.2"
      fill="none"
    />
...
const IconTalentManagement = () => (
  <svg width="38" height="38" viewBox="0 0 40 40" fill="none">
    <polygon
      points="20,6 35,31 5,31"
      stroke={G1}
      strokeWidth="1.4"
      fill="none"
    />
    <polygon
      points="20,12 30,28 10,28"
      stroke={G2}
      strokeWidth="1.1"
      fill="none"
    />
    <polygon
      points="20,19 26,28 14,28"
      stroke={G1}
      strokeWidth="0.9"
      fill="none"
      strokeOpacity="0.6"
...
const IconChangeManagement = () => (
  <svg width="38" height="38" viewBox="0 0 40 40" fill="none">
    ...
    />
    <path
      d="M32 20 A12 12 0 0 1 20 32"
      stroke={G1}
      strokeWidth="1.4"
      strokeLinecap="round"
    />
    <path
      d="M20 32 A12 12 0 0 1 8 20"
      stroke={G2}
      strokeWidth="1.4"
      strokeLinecap="round"
    />
    <path
      d="M8 20 A12 12 0 0 1 20 8"
      stroke={G2}
      strokeWidth="1.4"
      strokeLinecap="round"
...
const IconWorkforcePlanning = () => (
  <svg width="38" height="38" viewBox="0 0 40 40" fill="none">
    ...
    <path
      d="M11.5 11.5 L20 11.5 L20 20 L28.5 20 L28.5 28.5"
      stroke={G1}
      strokeWidth="1.3"
      fill="none"
      strokeLinecap="round"
...
const LocationIcon = () => (
  <svg width="16" height="20" viewBox="0 0 16 21" fill="none">
    <path
      d="M8 1C4.4 1 1.5 3.9 1.5 7.5C1.5 12.6 8 20 8 20C8 20 14.5 12.6 14.5 7.5C14.5 3.9 11.6 1 8 1Z"
      stroke={G1}
      strokeWidth="1.3"
      fill="none"
    />
...
const skillIcons = [
  IconStrategicPartnership,
  IconTalentManagement,
  IconChangeManagement,
  IconEmployeeRelations,
  IconPeopleAnalytics,
  IconODCulture,
  IconCoachingConsulting,
  IconWorkforcePlanning,
];
...
const skills = [
  {
    ...
    desc: "Aligning HR strategy with business objectives",
    detail:
      "Operating as a true business partner - not a support function. Understanding P&L, market dynamics, and organizational strategy to drive HR initiatives that create measurable business value.",
    tags: [
      "Business Acumen",
      "Executive Influence",
      "OKR Alignment",
  ...
  },
  {
    ...
    desc: "Full-cycle talent architecture and development",
    detail:
      "Designing end-to-end talent ecosystems: attraction, development, retention, and succession. Building capability frameworks and career pathways that grow people and protect organizational knowledge.",
    tags: [
      "Succession Planning",
      "Career Architecture",
      "9-Box Grid",
  ...
  },
  {
    ...
    desc: "Leading organizations through complex transitions",
    detail:
      "Architecting change at both individual and systemic levels - from restructures and integrations to culture transformation. Applying models like ADKAR and Kotter while holding space for human complexity.",
    tags: [
      "ADKAR",
      "Kotter 8-Step",
  ...
  },
  {
    ...
    desc: "Navigating complexity with fairness and precision",
    detail:
      "Managing the full spectrum of ER - from performance management and grievances to disciplinary proceedings and redundancy. Balancing legal compliance with genuine human care at every stage.",
    tags: [
      "Investigations",
      "Mediation",
      "PIP Design",
  ...
  },
  {
    ...
    desc: "Translating data into people strategy",
    detail:
      "Building the case for people decisions with data. Designing dashboards in Darwinbox, Keka, and GreytHR - interpreting engagement results, predicting attrition risk, and presenting workforce insights to leadership.",
    tags: [
      "Attrition Modeling",
  ...
  {
    name: "OD & Culture",
    desc: "Designing organizations that perform and endure",
    detail:
      "Shaping organizational structure, culture, and team effectiveness. Running diagnostics, facilitating offsites, and designing interventions that align culture with strategy for a modern, inclusive workspace.",
    tags: [
      "Org Design",
      "Team Effectiveness",
      "Culture Assessment",
  ...
  },
  {
    ...
    desc: "Developing leaders at every level",
    detail:
      "Acting as an internal consultant and coach to leaders - building self-awareness, emotional intelligence, and management capability. Mentoring employees and fostering growth mindset across the organization.",
    tags: [
      "Leadership Coaching",
      "360 Feedback",
      "Train the Trainer",
  ...
  },
  {
    ...
    desc: "Shaping the organization of tomorrow",
    detail:
      "Translating business strategy into headcount, capability, and structure decisions. Partnering with FP&A to manage allocated budgets for headcount and building models that anticipate skill gaps 12-24 months ahead.",
    tags: [
      "Headcount Planning",
      "Skills Gap Analysis",
      "Budget Management",
  ...
  "Talent & Performance": [
    {
      ...
      title: "Modern Performance Frameworks",
      body: "Moving beyond annual reviews to continuous feedback ecosystems. Best practice involves quarterly check-ins, real-time feedback tools, and OKR-based goal setting.",
      bullets: [
        "Separating development from compensation conversations",
        "Calibration sessions to reduce bias",
        "Using 9-box grids for talent reviews",
        "Managing underperformance with empathy and clarity",
      ],
    },
    {
      label: "Succession Planning",
      title: "Building the Leadership Pipeline",
      body: "Succession is not just about replacing the CEO - it is about ensuring every critical role has a ready successor. Effective planning identifies bench strength and accelerates development.",
      bullets: [
        "Critical role mapping and risk assessment",
        "Individual development plans (IDPs) for HiPos",
    ...
    },
    {
      ...
      title: "The HRBP's Role in Hiring",
      body: "HRBPs bridge the gap between TA teams and the business - shaping job design, setting quality bars, and ensuring equitable hiring processes at every stage.",
      bullets: [
        "Job architecture and leveling frameworks",
        "Structured interview design",
        "Offer strategy and market positioning",
    ...
    },
    {
      ...
      body: "Understanding why people leave - and why they stay - requires triangulating exit data, engagement survey results, and stay interview themes into clear action.",
      bullets: [
        "Engagement survey design and action planning",
        "Stay interview frameworks",
        "Flight risk identification",
        "Manager effectiveness as a retention lever",
      ],
    },
  ],
  "Compensation & Benefits": [
    {
      label: "Total Rewards",
      title: "Compensation Strategy and Benchmarking",
      body: "Competitive pay is table stakes - what differentiates employers is a transparent, equitable pay philosophy that employees understand and trust.",
      bullets: [
        "Market benchmarking with Radford, Mercer, Korn Ferry",
        "Pay band design and job evaluation",
        "Variable pay and incentive plan design",
        "Equity programs and long-term incentives",
      ],
    },
    {
      label: "Pay Equity",
      title: "Closing the Pay Gap",
      body: "Pay equity analysis is no longer optional - it is a legal, ethical, and reputational imperative. HRBPs must champion proactive pay equity reviews with data to back every decision.",
      bullets: [
        "Regression analysis basics for HRBPs",
        "Remediation planning and budget impact",
    ...
    },
    {
      ...
      title: "Benefits as a Retention Tool",
      body: "A well-designed benefits package communicates organizational values. Modern packages go beyond health insurance to address wellbeing, flexibility, and financial security.",
      bullets: [
        "Flexible benefits and total compensation statements",
        "Mental health and EAP investment",
    ...
    },
    {
      ...
      title: "Running Effective Compensation Cycles",
      body: "Annual salary review cycles require HRBPs to advise managers on merit budgets, equity adjustments, and retention awards - all with data to back decisions.",
      bullets: [
        "Merit matrix design",
        "Promotion vs. market adjustment distinction",
        "Managing expectations with limited budgets",
  ...
  "Employment Law": [
    {
      ...
      title: "Key Employment Law Areas for HRBPs",
      body: "HRBPs do not need a law degree - but they must know enough to recognize risk and engage legal counsel at exactly the right moment.",
      bullets: [
        "Protected characteristics and discrimination claims",
        "Wrongful termination and at-will employment",
        "Wage and hour compliance",
        "FMLA, ADA, and leave management",
      ],
    },
    {
      label: "Investigations",
      title: "Conducting Workplace Investigations",
      body: "A fair, thorough, and timely investigation protects both the organization and the complainant. Process integrity matters as much as the outcome reached.",
      bullets: [
        "Investigation planning and scope definition",
        "Interview techniques for sensitive matters",
    ...
    {
      label: "Separations",
      title: "Managing Terminations Lawfully",
      body: "Every termination carries legal risk. HRBPs ensure the documentation trail is solid, the process is consistent, and the exit experience preserves dignity for all parties.",
      bullets: [
        "At-will vs. for-cause terminations",
        "Severance agreement basics",
        "WARN Act applicability for RIFs",
        "Final pay and offboarding compliance",
      ],
    },
    {
      label: "Labour Relations",
      title: "Union Awareness and Labour Law Basics",
      body: "Even in non-union environments, HRBPs must understand labour rights and avoid practices that could trigger organizing activity or regulatory charges.",
      bullets: [
        "Protected concerted activity basics",
        "Recognizing early organizing signals",
        "Compliant workplace communication policies",
  ...
  "Learning & Development": [
    {
      ...
      body: "The most effective L&D is embedded in work, not separated from it. HRBPs design learning strategies tied to capability gaps and business outcomes - not just training calendars.",
      bullets: [
        "Learning needs analysis (LNA) process",
        "70-20-10 development model application",
        "Building vs. buying learning content",
        "Manager-as-coach enablement",
      ],
    },
    {
      label: "Leadership Programs",
      title: "Developing Leaders at Scale",
      body: "Leadership development is among the highest-ROI investments in any people strategy. HRBPs co-design programs that build capability across levels.",
      bullets: [
        "New manager assimilation programs",
        "High-potential accelerator design",
        "360 feedback integration",
        "Action learning and cohort programs",
      ],
    },
    {
      label: "Skills Strategy",
      title: "Future-Proofing Workforce Capability",
      body: "Skills are the new currency. HRBPs partner with the business to understand where capability gaps exist today and build pathways to close them before they become critical.",
      bullets: [
        "Skills taxonomy and ontology design",
        "Reskilling vs. upskilling vs. hiring decisions",
        "AI literacy and digital capability programs",
        "Internal mobility as a capability accelerator",
      ],
    },
    {
      label: "Measurement",
      title: "Proving L&D Impact",
      body: "The Kirkpatrick model remains the foundation - but modern L&D measurement goes further, linking programs to business metrics and real productivity outcomes.",
      bullets: [
        "Kirkpatrick 4-level evaluation",
        "Return on learning investment (ROLI)",
        "Pre/post skills assessments",
        "Connecting L&D to retention and engagement",
      ],
    },
  ],
  "DEI Strategy": [
    {
      label: "DEI Foundations",
      title: "Building an Equitable Organization",
      body: "DEI work is systems work. It requires examining every people process - hiring, promotion, compensation, development - through a consistent equity lens.",
      bullets: [
        "Representation data and goal-setting",
        "Equitable performance management practices",
        "Inclusive job design and JDs",
        "Promotion equity analysis",
      ],
    },
    {
      label: "Belonging",
      title: "Psychological Safety and Inclusion",
      body: "Diversity without inclusion is just optics. HRBPs focus on the conditions that allow all employees to contribute fully, speak freely, and be genuinely seen.",
      bullets: [
    ...
    {
      label: "Bias in Process",
      title: "Debiasing People Processes",
      body: "Bias is structural, not just individual. HRBPs redesign hiring, calibration, and review processes to reduce bias at every single decision point.",
      bullets: [
        "Structured interview design",
        "Blind resume screening",
        "Calibration facilitation to surface bias",
        "Pay equity and promotion parity reviews",
      ],
    },
    {
      label: "Strategy & Measurement",
      title: "Measuring What Matters in DEI",
      body: "Accountability requires data. HRBPs build DEI scorecards that go beyond headcount to measure inclusion, equity in outcomes, and leadership commitment.",
      bullets: [
        "DEI scorecard design",
...
const playbooks = [
  {
    num: "01",
    title: "Underperforming Senior Leader Playbook",
    tag: "Employee Relations - Performance",
    desc: "A structured approach to managing senior underperformance - from diagnosis through documentation to resolution.",
    tags: ["PIP", "ER", "Legal Risk"],
    steps: 5,
    situation:
      "A VP of Sales is consistently missing targets and receiving poor 360 feedback. The CEO wants action fast, but the VP has been with the organization 8 years and maintains strong customer relationships. No formal documentation exists.",
    stepList: [
      {
        title: "Diagnose Before Acting",
        body: "Gather data: review 360 feedback themes, revenue trends, exit interviews from their team. Meet 1:1 to understand their perspective - performance issues often have systemic contributors that leadership has not addressed.",
      },
      {
        title: "Partner with Legal Early",
        body: "Before any formal action, brief Employment Counsel on the situation and documentation gap. Align on process requirements, timelines, and potential risk exposure so there are no surprises later.",
      },
      {
        title: "Design a Transparent PIP",
        body: "Co-create a 60-90 day Performance Improvement Plan with specific, measurable expectations. Ensure the VP fully understands the stakes and has genuine support - coaching, resources, and regular check-ins.",
      },
      {
        title: "Coach the Manager",
        body: "Prepare the CEO to hold consistent, documented check-ins. Brief them on what to say and what to avoid - hearsay and inconsistency create legal exposure and undermine the entire process.",
      },
      {
        title: "Prepare for Both Outcomes",
        body: "Document every meeting and checkpoint in real time. Simultaneously plan for a successful outcome and a separation scenario - severance terms, transition planning, and client communication strategy.",
      },
    ],
    outcome:
      "Process integrity and documentation protect the organization. The VP either improves with real support or separates with dignity and legal protection on both sides.",
  },
  {
    num: "02",
    title: "Organizational Restructure Playbook",
    tag: "Change Management - OD",
    desc: "End-to-end guidance for executing a restructure with legal compliance, communication architecture, and survivor stabilization.",
    tags: ["Change", "OD", "Comms"],
    steps: 5,
    situation:
      "The business is restructuring two divisions into one, eliminating approximately 15% of roles. Leadership wants to execute in 6 weeks. Morale is already fragile after a difficult year.",
    stepList: [
      {
        title: "Map the Full Impact",
        body: "Before any communication, map every affected role, individual, and team. Identify critical talent at risk, key dependencies, and legal trigger points - WARN Act thresholds, notice periods, collective agreement obligations.",
      },
      {
        title: "Design the New Structure Deliberately",
        body: "Challenge leadership to define the future-state org before deciding who is at risk. Structure should follow strategy, not personalities or convenience.",
      },
      {
        title: "Build a Communication Architecture",
        body: "Design the full comms cascade: what is said, by whom, in what sequence, and in what medium. Simultaneous notification wherever possible prevents rumor mills from filling the vacuum.",
      },
      {
        title: "Support Affected Employees Genuinely",
        body: "Treat exits with real dignity - fair severance, reference letter support, outplacement services, and career transition resources. How people leave defines your employer brand.",
      },
      {
        title: "Stabilize the Survivors",
        body: "Restructure survivor syndrome is real and often overlooked. Hold town halls, create space for grief and questions, assign managers talking points, and over-communicate the vision for what comes next.",
      },
    ],
    outcome:
      "A well-executed restructure preserves trust with those who remain, honors those who leave, and positions the new organization to actually perform.",
  },
  {
    num: "03",
    title: "Toxic High Performer Playbook",
    tag: "Culture - Employee Relations",
    desc: "How to handle bullying behavior from a top contributor - quantifying true cost, escalation paths, and holding the line professionally.",
    tags: ["Culture", "ER", "Risk"],
    steps: 5,
    situation:
      "Your top revenue generator is repeatedly accused of bullying behavior toward their team. Three strong performers have left, citing this person. Leadership is pressuring HR to make the complaints disappear.",
    stepList: [
      {
        title: "Refuse to Suppress Complaints",
        body: "Document formally that complaints were received and will be investigated, regardless of leadership pressure. Failure to act creates company and personal liability for HR. Your professional integrity is non-negotiable.",
      },
      {
        title: "Quantify the True Cost",
        body: "Build the business case: calculate the full cost of three departures - recruitment fees, ramp time, lost productivity, institutional knowledge loss. Compare to the high performer's revenue contribution. The math often surprises leaders.",
      },
      {
        title: "Escalate with Data",
        body: "Present your findings to the CHRO and General Counsel if business leaders block action. Frame this as risk management - legal exposure, attrition cost, reputational risk, and future talent loss.",
      },
      {
        title: "Structure Accountability",
        body: "If the high performer stays, create documented behavioral expectations with real consequences attached. Their targets mean nothing if they destroy the team achieving them alongside them.",
      },
      {
        title: "Hold the Line",
        body: "Your role is to represent the organization's long-term health, not short-term comfort. Document your recommendations formally. Know when to escalate to the Board.",
      },
    ],
    outcome:
      "Culture is determined by who you retain and what you tolerate. Protecting a toxic high performer costs far more than it saves - financially, culturally, and reputationally.",
  },
  {
    num: "04",
    title: "Post-Merger Integration Playbook",
    tag: "Change Management - OD",
    desc: "A 90-day HR integration framework covering cultural diagnostics, people risk mapping, process harmonization, and communication.",
    tags: ["M&A", "OD", "Change"],
    steps: 5,
    situation:
      "Your organization has acquired a 400-person firm with a distinct culture, a different HRIS, separate pay scales, and competing values. You have 90 days to present a credible integration plan.",
    stepList: [
      {
        title: "Run a Cultural Diagnostic",
        body: "Survey and interview employees on both sides before making any structural decisions. Identify where cultures genuinely complement and where they conflict. The best integrations consciously take the best of both.",
      },
      {
        title: "Map the People Risks",
        body: "Identify flight-risk talent on the acquired side - often the very people the acquisition was made for. Retention bonuses and honest individual conversations go much further than generic job security platitudes.",
      },
      {
        title: "Harmonize People Processes",
        body: "Align performance cycles, pay philosophies, benefits, and policies on a clear timeline. Visible differences in how people are treated create two-tier organizations that breed resentment.",
      },
      {
        title: "Align Leadership Quickly",
        body: "Conflicting signals from two sets of leaders create paralysis throughout the organization. Facilitate joint leadership workshops to align on values, operating model, and decision rights.",
      },
      {
        title: "Communicate Relentlessly",
        body: "In the absence of information, people always assume the worst. Establish a 90-day communication cadence with clear milestones, genuinely honest updates, and a named channel for employee questions.",
      },
    ],
    outcome:
      "Successful M&A integration is 80% people and culture. A rigorous, empathetic HR integration plan is the single biggest determinant of whether the deal value is actually realized.",
  },
];
...
const frameworks = [
  {
    icon: "◉",
    name: "Ulrich's HR Model",
    desc: "The foundational framework for modern HR - four distinct roles that drive organizational effectiveness.",
    items: [
      "Strategic Partner - aligning HR with business strategy",
      "Change Agent - leading transformation",
      "Administrative Expert - process efficiency",
      "Employee Champion - advocacy and wellbeing",
    ],
  },
  {
    icon: "⬡",
    name: "9-Box Talent Grid",
    desc: "A matrix for evaluating current performance and future potential - cornerstone of talent calibration and succession.",
    items: [
      "X-axis: Current Performance (Low to High)",
      "Y-axis: Future Potential (Low to High)",
      "Stars: High performance + High potential",
      "Risking talent vs. Solid performers distinction",
    ],
  },
  {
    icon: "△",
    name: "ADKAR Change Model",
    desc: "Prosci's individual change model - each person must progress through all five stages for adoption to succeed.",
    items: [
      "Awareness - of the need for change",
      "Desire - to support and participate",
      "Knowledge - of how to change",
      "Ability and Reinforcement - to sustain",
    ],
  },
  {
    icon: "□",
    name: "Kirkpatrick Model",
    desc: "The four-level evaluation framework for measuring learning effectiveness and organizational impact.",
    items: [
  ...
  {
    icon: "◈",
    name: "Lencioni's 5 Dysfunctions",
    desc: "The team effectiveness model identifying root causes of poor team performance - and targeted interventions.",
    items: [
      "Absence of Trust - vulnerability-based",
      "Fear of Conflict - productive debate",
      "Lack of Commitment - clarity and buy-in",
      "Inattention to Results - team outcomes first",
    ],
  },
  {
    icon: "○",
    name: "HR Value Chain",
    desc: "The causal model connecting HR practices through employee behaviors to business outcomes - essential for proving HR impact.",
    items: [
      "HR Practices to Employee Competencies",
      "Competencies to Employee Behaviors",
      "Behaviors to Organizational Outcomes",
...
const playbookCards = [
  ...
  {
    type: "Culture Playbook",
    title: "Toxic High Performer Playbook",
    desc: "How to handle bullying behavior from a top contributor - quantifying true cost, escalation paths, and holding the line.",
    tags: ["Culture", "ER", "Risk"],
    steps: 5,
    idx: 2,
  },
  ...
  },
  {
    ...
    title: "New Hire 30-60-90 Day Playbook",
    desc: "A structured engagement framework for new hires - milestone check-ins, productivity acceleration, and early relationship building.",
    tags: ["Onboarding", "Engagement", "Retention"],
    steps: 5,
    idx: 0,
  },
  {
    type: "Engagement Playbook",
    title: "Employee Engagement Diagnostic Playbook",
    desc: "How to run a meaningful engagement cycle - survey design, results analysis, action planning, and closing the feedback loop.",
    tags: ["Engagement", "Analytics", "Culture"],
    steps: 5,
    idx: 1,
  },
];
...
const templateCards = [
  {
    icon: "📋",
    name: "PIP Template",
    desc: "A structured Performance Improvement Plan template with goal-setting, milestone tracking, and manager guidance.",
    items: [
      "Performance baseline section",
      "SMART goal framework",
      "Weekly check-in log",
      "Formal outcome documentation",
    ],
  },
  {
    icon: "🔍",
    name: "Investigation Framework",
    desc: "A step-by-step workplace investigation template - from complaint intake through findings and recommended action.",
    items: [
  ...
  {
    icon: "🗂️",
    name: "Job Architecture Template",
    desc: "A leveling framework template to define roles, responsibilities, and career progression across functions.",
    items: [
      "Level definitions (IC and Manager tracks)",
      "Competency descriptors",
      "Compensation range mapping",
  ...
  },
  {
    ...
    desc: "Key HR metrics and reporting structure designed for HRBP reporting to senior leadership.",
    items: [
      "Headcount and attrition dashboard",
      "Engagement score tracking",
      "Time-to-hire and quality metrics",
      "Diversity representation reporting",
    ],
  },
  {
    icon: "🤝",
    name: "Onboarding Checklist",
    desc: "A comprehensive new hire onboarding checklist covering pre-boarding through 90 days.",
    items: [
      "Pre-boarding document checklist",
      "Day 1 experience guide",
  ...
  {
    icon: "🎯",
    name: "9-Box Calibration Guide",
    desc: "A facilitation guide for running talent calibration sessions - definitions, steps, and action-planning outputs.",
    items: [
      "Performance and potential definitions",
      "Calibration session agenda",
      "Conversation guide for managers",
      "Talent action plan template",
    ],
  },
];
...
const quickRefCards = [
  {
    type: "Framework",
    title: "ADKAR at a Glance",
    desc: "The 5-stage individual change model - use this to diagnose exactly where change resistance is coming from and intervene with precision.",
    tags: ["Change", "Prosci"],
  },
  {
    type: "Framework",
    title: "Ulrich Model Quick Reference",
    desc: "Four HR roles mapped to organizational needs. Use this to position HR conversations with business leaders strategically and credibly.",
    tags: ["Strategy", "HR Model"],
  },
  {
    type: "Concept",
    title: "9-Box Facilitation Guide",
    desc: "How to run a talent calibration session using the 9-box - definitions, facilitation tips, and common calibration traps to avoid.",
    tags: ["Talent", "Calibration"],
  },
  {
    type: "Metric",
    title: "Key HRBP Metrics Cheatsheet",
    desc: "The 12 metrics every HRBP should track: attrition rate, time-to-fill, engagement score, span of control, and more with context.",
...
export default function HRBPLanding() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      ...
      setCounts({
        ...
        employees: Math.round(targets.employees * e),
  ...
  const openPlaybook = (idx) => {
    ...
    setOverlayOpen(true);
    setTimeout(() => {
      overlayRef.current?.querySelector(".pb-content")?.scrollTo(0, 0);
    }, 50);
  };
  ...
  const scrollKTabs = (dir) => {
    kTabsRef.current?.scrollBy({ left: dir * 200, behavior: "smooth" });
  };
  ...
  const connectCards = [
    {
      iconEl: (
        <span style={{ fontFamily: "'Cormorant Garamond',serif", fontWeight: 700, fontSize: 15 }}>
          in
        </span>
      ),
      label: "LinkedIn",
      href: "https://www.linkedin.com/in/gayathri-venu-nair/",
      value: "linkedin.com/in/gayathri-venu-nair",
    },
    {
      iconEl: <span style={{ fontSize: 14 }}>▶</span>,
      label: "Open to Opportunities",
      href: "#",
      value: "Senior HRBP - People Director",
    },
    {
      iconEl: (
        <span style={{ fontFamily: "'Cormorant Garamond',serif", fontWeight: 700, fontSize: 18 }}>
          ◎
        </span>
      ),
      label: "Specializations",
      href: "#",
      value: "Fintech - IT - Marketing",
    },
    {
      iconEl: <LocationIcon />,
      label: "Location",
  ...
  return (
    <>
        ...
        <div className="pb-overlay-body">
          <div className="pb-list">
            ...
            {playbooks.map((p, i) => (
              <div
                key={i}
                className={`pb-list-item ${overlayPlaybook === i ? "active" : ""}`}
                onClick={() => {
                  setOverlayPlaybook(i);
                  overlayRef.current
                    ?.querySelector(".pb-content")
          ...
          <div className="pb-content">
            ...
            <div className="pb-content-sub">
              {pb.tags.join(" · ")} · {pb.steps} steps
            </div>
            ...
            <div className="pb-steps">
              {pb.stepList.map((step, i) => (
                <div className="pb-step" key={i}>
                  <div className="pb-step-num-col">
                    <div className="pb-step-num-badge">{i + 1}</div>
                  </div>
      ...
      <nav className="nav">
        ...
        <button className="nav-cta" onClick={() => scrollTo("connect")}>
          Let&apos;s Connect
        </button>
      </nav>
      ...
      <section className="hero" id="home">
        <div className="hero-left">
          ...
          <div className="hero-name serif fade-up d2">
            Gayathri
            <br />
            <strong>Kaur Nair</strong>
          </div>
          ...
          <p className="hero-tagline serif fade-up d3">
            &quot;People strategy is business strategy. I build the bridge between human
            potential and organizational performance.&quot;
          </p>
          <div className="hero-stats fade-up d4">
            <div>
              <div className="stat-num serif">{counts.years}+</div>
              <div className="stat-label">Years in HR</div>
            </div>
            <div>
              <div className="stat-num serif">
                {counts.employees >= 1000
                  ? `${(counts.employees / 1000).toFixed(1)}k`
                  : counts.employees}
              </div>
              <div className="stat-label">Employees Supported</div>
            </div>
            <div>
              <div className="stat-num serif">{counts.projects}+</div>
              <div className="stat-label">HR Projects Delivered</div>
            </div>
          </div>
        </div>
        ...
        <div className="hero-right">
          ...
          <h2 className="serif fade-up d2">
            Turning people complexity
            <br />
            into organizational strength
          </h2>
          <p className="hero-intro fade-up d3">
            6+ years of building people strategies that move businesses forward.
            From Fintech to IT to Marketing, I specialize in talent management,
            employee engagement, and partnering with leadership to build
            people-first, high-performing organizations.
          </p>
          <div className="pill-group fade-up d4">
            {["Fintech", "IT", "Marketing", "Scale-Up", "Dubai / UAE"].map((p) => (
          ...
          <div className="cta-row fade-up d5">
            <a href="#playbooks" className="btn-primary">
              Explore HRBP Playbooks
            </a>
            <button className="btn-outline" onClick={() => scrollTo("connect")}>
              Let&apos;s Connect
            </button>
          </div>
        </div>
      ...
      <section className="section skills-section" id="skills">
        <div className="skills-meta">
          <div>
            ...
            <div className="section-heading serif">
              My Eight capabilities that define
              <br />
              <em>impactful HR partnership</em>
            </div>
          </div>
        ...
        <div className="skills-grid">
          {skills.map((skill, i) => {
            ...
            return (
              <div
                key={i}
                className={`skill-card ${activeSkill === i ? "active" : ""}`}
              ...
              <div className="skill-expand-inner">
                <div className="skill-expand-left">
                  <div className="skill-expand-icon">
                    {(() => {
                      const I = skillIcons[activeSkill];
                      return <I />;
                    })()}
                  </div>
      ...
      <section className="section knowledge-section" id="knowledge">
        ...
        <div className="section-heading serif">
          Sharing what <em>great HR</em> looks like
          <br />
          across every domain
        </div>
        ...
        <div className="knowledge-tabs-outer">
          <div className="knowledge-tabs" ref={kTabsRef}>
            {knowledgeTabs.map((tab) => (
              <button
                key={tab}
                className={`ktab ${activeKTab === tab ? "active" : ""}`}
                onClick={() => setActiveKTab(tab)}
              >
                {tab}
              </button>
            ))}
          ...
          <div className="ktab-nav">
            <div className="ktab-arrow" onClick={() => scrollKTabs(-1)}>
              ‹
            </div>
            <div className="ktab-arrow" onClick={() => scrollKTabs(1)}>
              ›
      ...
      <section className="section playbooks-section" id="playbooks">
        ...
        <div className="section-heading serif">
          ...
          <br />
          <em>complex HRBP situations</em>
        </div>
        <p className="scenario-intro">
          Real playbooks built from first-hand experience. Click any card to open
          the full playbook.
        </p>
          ...
          {playbooks.map((p, i) => (
            <div className="playbook-card" key={i} onClick={() => openPlaybook(i)}>
              ...
              <div className="playbook-tag-row">
                {p.tags.map((t) => (
                  <span className="playbook-tag" key={t}>
                    {t}
                  </span>
                ))}
              </div>
              ...
              <div className="playbook-cta">
                Open Playbook <span className="playbook-cta-arrow">→</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="resources-header">
          <div>
            ...
            <div className="section-heading serif">
              A living library of
              <br />
              <em>HR tools and references</em>
            </div>
          </div>
          <p>
            Practical resources built from real HRBP experience - playbooks,
            templates, certifications, and quick references.
          </p>
        </div>
        ...
        <div className="resources-tabs-outer">
          <div className="resources-tabs">
            {resourceTabs.map((tab) => (
              <button
                key={tab}
                className={`rtab ${activeRTab === tab ? "active" : ""}`}
                onClick={() => setActiveRTab(tab)}
              >
                {tab}
              </button>
            ))}
            ...
            {playbookCards.map((card, i) => (
              <div className="rcard" key={i} onClick={() => openPlaybook(card.idx)}>
                ...
                <div className="rcard-tags">
                  {card.tags.map((t) => (
                    <span className="rcard-tag" key={t}>
                      {t}
                    </span>
                  ))}
                </div>
              ...
              <div className="template-card" key={i}>
                ...
                <div>
                  {card.items.map((item, j) => (
                    <div className="template-item" key={j}>
                      {item}
                    </div>
                  ))}
                </div>
          ...
          <div className="resources-panel active two-col">
            {quickRefCards.map((card, i) => (
              <div className="rcard" key={i}>
                ...
                <div className="rcard-meta">
                  <span className="rcard-steps">Reference card</span>
                  <span className="rcard-arrow">→</span>
                </div>
              </div>
            ))}
      ...
      <section className="connect-section" id="connect">
        <div className="connect-left">
          ...
          <p>
            Whether you are an HR practitioner looking to exchange ideas, a leader
            seeking an experienced HRBP partner, or a team building out your people
            function - I would love to connect.
          </p>
        </div>
      ...
      <footer>
        <div className="footer-brand serif">
          Gayathri Kaur Nair <span>·</span> HRBP
        </div>
